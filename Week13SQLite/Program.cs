...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enter date of birght (mm-dd-yyyy):");
    dob = Console.ReadLine();

    command = myConnection.CreateCommand();
    command.CommandText = $"INSERT INTO customer(firstName, lastName, dateOfBirgth) VALUES ('{fName}', '{lName}', {dob}')";
...
static void RemoveCustomer(SQLiteConnection myConnection)
{
    ...
    command = myConnection.CreateCommand();
    command.CommandText = $" DELETE FROM cutomer WHERE rowid = {idToDelete} ";
